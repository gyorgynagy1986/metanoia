...
export const hero = {
  h1: "Holisztikus Masszázs Terápiák",
  h1_: "Hangtál harmonizáció, önismereti kártya, személyre szabott illóolajok, és egy különleges masszázs fúziója",
};
...
export const section_7 = {
  ...
  list_2: [
    { title: "Nyitókör" },
    { title: "Női jóga" },
    { title: "Méh belső hangjával való kapcsolódás" },
    { title: "Méh terének tisztítása" },
    { title: "Vizualizáció, meditáció" },
    { title: "Hangfürdő" },
    { title: "Zárókör-közös rituális ital elfogyasztása" },
  ],
...
export const formDatas = {
  text: " Köszönöm, hogy felkerested a Metanoia Terápiát! Szívesen válaszolok minden kérdésedre vagy megkeresésedre.",
  phone: " +36 30 492 1066",
  email: "hello@metanoiaterapia.hu",
  text2: "Ha nem venném fel, ne haragudj, valószínűleg terápiát tartok. Visszahívlak!",
